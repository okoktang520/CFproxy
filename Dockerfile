...
RUN a2enmod  rewrite
RUN wget https://raw.githubusercontent.com/okoktang520/newjob/main/000-default.conf
RUN rm /etc/apache2/sites-available/000-default.conf
RUN mv 000-default.conf /etc/apache2/sites-available
RUN echo 'Please pay attention to the follow-up!' >/var/www/html/index.html
